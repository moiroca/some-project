  ...
  <div class="col-lg-12"  style="margin-top:20px;">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h1 class="panel-title">New Office Head</h1>
			</div >
			<div class="panel-body">
				 <?php echo validation_errors(); ?>
				 <form class="form" method="POST" action=<?php echo base_url("addOfficeHead"); ?>>
				  ...
				  <div class="form-group">
					...
					<input class="form-control" type="text" id="name" name="lastname" placeholder="Lastname" value="<?php echo set_value('lastname'); ?>" required/>
				  </div>
				  <div class="form-group">
					<label class="control-label" >First Name <i class="fa fa-asterisk"></i></label>
					<input class="form-control" type="text" id="name" name="firstname" placeholder="Firstname"  value="<?php echo set_value('firstname'); ?>" required/>
				  </div>
				  <div class="form-group">
					<label class="control-label" >Middle Name <i class="fa fa-asterisk"></i></label>
					<input class="form-control" type="text" id="name" name="middlename" placeholder="Middlename"  value="<?php echo set_value('middlename'); ?>" required/>
				  </div> 
				  <div class="form-group">
